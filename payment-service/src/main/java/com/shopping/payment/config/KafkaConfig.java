...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OrderEventDto> consumerFactory() {
        ...
        JsonDeserializer<OrderEventDto> jsonDeserializer = new JsonDeserializer<>(OrderEventDto.class);
        jsonDeserializer.addTrustedPackages("com.shopping.order.dto", "com.shopping.payment.dto");
